...
import 'package:mytrip/dao/travel_tab_dao.dart';
import 'package:mytrip/pages/travel_tab_page.dart';
  ...
  @override void initState() {
    ...
    TravelTabDao.fetch().then((TravelTabModel model) {
      _tabController = TabController(
          length: model.tabs.length, vsync: this); //fix tab label ç©ºç™½é—®é¢˜
      setState(() {
        _tabs = model.tabs;
        _tabModel = model;
      });
