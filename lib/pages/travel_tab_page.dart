...
import 'package:mytrip/dao/travel_dao.dart';
import 'package:mytrip/model/travel_model.dart';
import 'package:mytrip/widget/loading_container.dart';
import 'package:mytrip/widget/web_view_widget.dart';

const PAGE_SIZE = 10;
const PAGE_URL = 'https://m.ctrip.com/restapi/soa2/16189/json/searchTripShootListForHomePageV2?_fxpcqlniredt=09031014111431397988&__gw_appid=99999999&__gw_ver=1.0&__gw_from=10650013707&__gw_platform=H5';
...
class _TravelTabPageState extends State<TravelTabPage> with AutomaticKeepAliveClientMixin{
  ...
  void _loadData({loadMore = false}) {
    ...
    TravelDao.fetch(widget.travelUrl ?? PAGE_URL, widget.params,
      ...
      setState(() {
        List<TravelItem> items = _filterItmes(model.resultList);
  ...
  List<TravelItem> _filterItmes(List<TravelItem> resultList) {
    if (resultList == null) {
      return [];
    }
